...
##Problemas com caracteres estranhos num DF ou ao abrir um .Rmd num outro lugar
- Caso ao abrir um csv esteja vendo caracteres estranhos, tente fazer o seguinte: 
```{r}
read.csv("arquivo.csv", encoding = "utf-8")
```

- Caso esteja com problemas ao abrir o .Rmd em um outro computador:
